...
int main (int argc, char *argv[])
{
    ...
    while (1) {
        ...
        the_message = prepare_message(externalIndex, externalTemp, false); 
        ...
        if (the_message.done) {
            printf("--------------------------------------------------------\n");
            printf("System stabilized. Final temperature for process %d = %.2f\n", externalIndex, externalTemp);
            break;
        }
        ...
        printf("Updated temperature for process %d = %.2f\n", externalIndex, externalTemp);
        printf("--------------------------------------------------------\n\n");
    }
